...
var app = angular.module('focusconcursos', ['ionic','ionic.service.core','focusconcursos.services','ionic.service.push','ionicLazyLoad','ngCordova']);
/*
...
*/
app.run(function($ionicPlatform, $rootScope, $ionicLoading, $ionicUser, $ionicPush, $cordovaPush) {
    ...
    $ionicPlatform.ready(function() {
        ...
        $ionicPush.init({
            ...
            "onNotification": function(notification) {
               ...
               // alert(JSON.stringify(notification), JSON.stringify(payload));
            },
        ...
        angular.extend(user, {
            ...
            email: localStorage.getItem('aluno.email'),
...
app.controller('DashCtrl', function($scope, $rootScope, $http, $ionicUser, $ionicPush) {
    var key = '';
    var s = '';
    var lista = '';
    var itens = [];
